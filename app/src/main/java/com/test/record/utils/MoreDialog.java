...
import com.test.record.action.AboutActivity;
import com.test.record.action.HistoryActivity;
import com.test.record.action.MonthChartActivity;
import com.test.record.R;
import com.test.record.action.SettingActivity;
