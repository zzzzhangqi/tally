...
import com.test.record.adapter.AccountAdapter;
import com.test.record.db.AccountBean;
import com.test.record.db.DBManager;
import com.test.record.utils.BudgetDialog;
import com.test.record.utils.MoreDialog;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtil.setColor(this,getColor(R.color.tittle_2),0);
        initTime();
        initView();
