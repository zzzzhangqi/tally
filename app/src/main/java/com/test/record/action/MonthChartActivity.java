...
import com.test.record.adapter.ChartVPAdapter;
import com.test.record.db.DBManager;
import com.test.record.frag_chart.IncomChartFragment;
import com.test.record.frag_chart.OutcomChartFragment;
import com.test.record.utils.CalendarDialog;
